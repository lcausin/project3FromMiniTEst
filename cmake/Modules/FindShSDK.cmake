...
if (SHSDK_LIBRARY)
	...
	if (CMAKE_SYSTEM_NAME MATCHES "Android")
		...
		# For Android
		if (CMAKE_SYSTEM_NAME MATCHES "Android")
			FIND_SHSDK_LIBRARY(NATIVE_APP_GLUE_LIBRARY native_app_glue)
		endif (CMAKE_SYSTEM_NAME MATCHES "Android")

		
		list(APPEND SHSDK_LIBRARIES "${OPENGLES2_LIBRARIES}" "${EGL_LIBRARIES}" "${OPENSLES_LIBRARIES}" "${LIB_ANDROID}" "${LIB_LOG}" "${NATIVE_APP_GLUE_LIBRARY}")
